...
export const heroAvatarSrcSet: ImageSrcSet = {
    dk: AvatarDkWebp,
    dkAvif: AvatarDkAvif,
    dk2x: AvatarDk2xWebp,
    dkAvif2x: AvatarDk2xAvif,
    dk3x: AvatarDk3xWebp,
    dkAvif3x: AvatarDk3xAvif,
    dkTiny: AvatarDkTinyWebp,
    tb: AvatarDkWebp,
    tbAvif: AvatarDkAvif,
    tb2x: AvatarDk2xWebp,
    tbAvif2x: AvatarDk2xAvif,
    tb3x: AvatarDk3xWebp,
    tbAvif3x: AvatarDk3xAvif,
    tbTiny: AvatarDkTinyWebp,
    mb: AvatarMbWebp,
    mbAvif: AvatarMbAvif,
    mb2x: AvatarMb2xWebp,
    mbAvif2x: AvatarMb2xAvif,
    mb3x: AvatarMb3xWebp,
    mbAvif3x: AvatarMb3xAvif,
    mbTiny: AvatarMbTinyWebp,
};

export const journey1SrcSet: ImageSrcSet = {
    dk: Journey1DkWebp,
    dkAvif: Journey1DkAvif,
    dk2x: Journey1Dk2xWebp,
    dkAvif2x: Journey1Dk2xAvif,
    dk3x: Journey1Dk3xWebp,
    dkAvif3x: Journey1Dk3xAvif,
    dkTiny: Journey1DkTinyWebp,
    tb: Journey1DkWebp,
    tbAvif: Journey1DkAvif,
    tb2x: Journey1Dk2xWebp,
    tbAvif2x: Journey1Dk2xAvif,
    tb3x: Journey1Dk3xWebp,
    tbAvif3x: Journey1Dk3xAvif,
    tbTiny: Journey1DkTinyWebp,
    mb: Journey1MbWebp,
    mbAvif: Journey1MbAvif,
    mb2x: Journey1Mb2xWebp,
    mbAvif2x: Journey1Mb2xAvif,
    mb3x: Journey1Mb3xWebp,
    mbAvif3x: Journey1Mb3xAvif,
    mbTiny: Journey1MbTinyWebp,
};

export const journey2SrcSet: ImageSrcSet = {
    dk: Journey2DkWebp,
    dkAvif: Journey2DkAvif,
    dk2x: Journey2Dk2xWebp,
    dkAvif2x: Journey2Dk2xAvif,
    dk3x: Journey2Dk3xWebp,
    dkAvif3x: Journey2Dk3xAvif,
    dkTiny: Journey2DkTinyWebp,
    tb: Journey2DkWebp,
    tbAvif: Journey2DkAvif,
    tb2x: Journey2Dk2xWebp,
    tbAvif2x: Journey2Dk2xAvif,
    tb3x: Journey2Dk3xWebp,
    tbAvif3x: Journey2Dk3xAvif,
    tbTiny: Journey2DkTinyWebp,
    mb: Journey2MbWebp,
    mbAvif: Journey2MbAvif,
    mb2x: Journey2Mb2xWebp,
    mbAvif2x: Journey2Mb2xAvif,
    mb3x: Journey2Mb3xWebp,
    mbAvif3x: Journey2Mb3xAvif,
