...
const Services: FC<{ className?: string }> = ({ className }) => {
    return (
        <AppSection
            className={cn(
                'full-bleed relative isolate xl:flex xl:items-center xl:gap-21 xl:px-(--padding) 2xl:gap-16',
                className,
            )}
        >
            <ServicesInfo />
        ...
        <div class="mb-18 sm:mb-20.5 lg:mx-auto lg:max-w-155 xl:mx-0 xl:mb-0 xl:max-w-123.5 2xl:max-w-187">
            ...
            >
                {locale.value === 'en'
                    ...
                    : 'Вот основные типы услуг, которые я оказываю клиентам. Я специалируюсь на разработке бэкэнда, фронтэнда, а также настройке серверов. При необходимости создания дизайна, настройки CEO, либо по каким-либо других вопросам, я, как правило, привлекаю к работе специалиста в данной области.'}
            </p>
        </div>
    );
};
